 ...
 * The purpose of this class is to run the program to create and manipulate a database of inputted Affiliates.
...
public class AffiliatesDriver {
  /** A HashMap which is the database and maps IDs to Affiliates */
  private static HashMap<Long, Affiliates> database = new HashMap<Long, Affiliates>();
  /** A Scanner declared here so all methods can use it */
  ...
  /** Method printing the options the user has */
  ...
  /** Method asking for an ID and printing the Affiliates' info by using it's print() method if it exists in the database, tells you it isn't in database otherwise */
  public static void printInfo() {
    System.out.println("Enter an ID to print the information of that Affiliate: ");
    long id = scan.nextLong();
    scan.nextLine(); //eats newline after int
  ...
  /**
    * Method that sorts affiliates in database by seniority and prints them in that order.
    * First, puts all Affiliates from database into an ArrayList,
    * Uses bubble sort algorithm to sort ArrayList by using getYearCameToChapman() method,
    * Prints Affiliates from ArrayList in order.
    */
  public static void listInOrder() {
    ArrayList<Affiliates> orderedBySeniority = new ArrayList<Affiliates>();
    for (Affiliates value: database.values()) {
  ...
  /** Method asking for ID to and deleting that Affiliates from the database */
  ...
  /**
    * Method that checks what class type this Affiliates is, adds all of it's instance variables to a String by using it's getter methods, and returns that String
    * @param aff the Affiliates to print to the file
    * @return a String that will be a whole line to print to the file
    */
  ...
  /** Method clearing database and restoring it by reading the contents of a file of the user's choosing by creating a new Affiliates from the line using the Overloaded constructors. */
  ...
  /** Method creating an Assistant and putting it into the database by asking the user for all of its information - catches/prints Exception if invalid type is entered and returns to main menu options (1-7). */
  public static void createAssistant() {
    try {
      ...
      scan.nextLine(); //eats new line after int
  ...
  /** Method creating an Associate and putting it into the database by asking the user for all of its information - catches/prints Exception if invalid type is entered and returns to main menu options (1-7). */
  ...
  /** Method creating a Full and putting it into the database by asking the user for all of its information - catches/prints Exception if invalid type is entered and returns to main menu options (1-7). */
  ...
  /** Method creating a Graduate and putting it into the database by asking the user for all of its information - catches/prints Exception if invalid type is entered and returns to main menu options (1-7). */
  ...
  /** Method creating an Undergrad and putting it into the database by asking the user for all of its information - catches/prints Exception if invalid type is entered and returns to main menu options (1-7). */
  ...
  /** Method creating an FullTime and putting it into the database by asking the user for all of its information - catches/prints Exception if invalid type is entered and returns to main menu options (1-7). */
  ...
  /** Method creating a PartTime and putting it into the database by asking the user for all of its information - catches/prints Exception if invalid type is entered and returns to main menu options (1-7). */
